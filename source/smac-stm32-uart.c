...
static smacUartEventOnTxComplete on_tx_complete;
static smacUartEventOnRxComplete on_rx_complete;
static smacUartEventOnRxSizeComplete on_rx_size_complete;
static smacUartEventOnAbort on_abort;
static smacUartEventOnError on_error;
